...
#define com_apress_echo_EchoServerActivity_BIND_ADJUST_WITH_ACTIVITY 128L
...
#undef com_apress_echo_EchoServerActivity_MODE_ENABLE_WRITE_AHEAD_LOGGING
#define com_apress_echo_EchoServerActivity_MODE_ENABLE_WRITE_AHEAD_LOGGING 8L
